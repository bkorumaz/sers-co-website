    ...
    <>
      <div className="min-h-screen dark:bg-gray-800 dark:text-gray-100">
        <div className="p-6 space-y-8">
          <header className="fixed container flex items-center justify-between h-16 px-4 mx-auto rounded dark:bg-gray-900">
            ...
            <div className="container flex justify-between h-16 mx-auto">
              ...
              <div className="flex items-center md:space-x-4">
                ...
                <button
                  type="button"
                  className="hidden px-6 py-2 font-semibold rounded lg:block dark:bg-indigo-400 dark:text-gray-900"
                >
                  Log in
                </button>
              </div>
                    ...
                    <div className="flex space-x-2 sm:space-x-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="leadi">
                          ...
                          repudiandae quaerat obcaecati voluptatem similique!
                        </p>
                      </div>
                    </div>
                    <div className="flex space-x-2 sm:space-x-4">
