          ...
          <header className="container flex items-center justify-between h-16 px-4 mx-auto rounded dark:bg-gray-900">
            <a rel="noopener noreferrer" href="#" aria-label="Homepage">
              <svg
                ...
                fill="currentColor"
                viewBox="0 0 32 32"
                className="w-6 h-6 dark:text-indigo-400"
              >
            ...
            <div className="items-center hidden space-x-8 lg:flex">
              ...
              <button className="px-4 py-2 rounded-md dark:bg-indigo-400 dark:text-gray-900">
                Sign up
              </button>
            </div>
            ...
            <div className="container mx-auto space-y-16">
              <section className="grid gap-6 text-center lg:grid-cols-2 xl:grid-cols-5">
                <div className="w-full p-6 rounded-md sm:p-16 xl:col-span-2 dark:bg-gray-900">
                  <span className="block mb-2 dark:text-indigo-400">
                    Mamba design system
                  </span>
                  ...
                  >
                    ...
                    <button className="w-full py-2 font-semibold rounded dark:bg-indigo-400 dark:text-gray-900">
                      Join the waitlist
                    </button>
                  </form>
                </div>
              ...
              <section>
                <span className="block mb-2 text-xs font-medium tracki uppercase lg:text-center dark:text-indigo-400">
                  How it works
                </span>
                ...
                <div className="grid gap-6 my-16 lg:grid-cols-3">
                  <div className="flex flex-col p-8 space-y-4 rounded-md dark:bg-gray-900">
                    <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 text-xl font-bold rounded-full dark:bg-indigo-400 dark:text-gray-900">
                      1
                    </div>
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                  <div className="overflow-hidden rounded lg:flex lg:col-span-3">
                    ...
                    <div className="p-6 space-y-6 lg:p-8 md:flex md:flex-col dark:bg-gray-900">
                      <span className="self-start px-3 py-1 text-sm rounded-full dark:bg-indigo-400 dark:text-gray-900">
                        Business
                      </span>
