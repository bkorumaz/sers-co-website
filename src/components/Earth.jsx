...
export default function Model(props) {
  const group = useRef();
  const { nodes, materials } = useGLTF("https://raw.githubusercontent.com/bkorumaz/3d-project/main/src/3d-assets/oceanic_currents.gltf");
  return (
...
useGLTF.preload("/oceanic_currents.gltf");
